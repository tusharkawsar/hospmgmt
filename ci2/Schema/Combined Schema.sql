...
insert into doctor values('d002', 'd002', 'Dr. B', 'Elephant Road', 01682980424, 31, 'current', 'a@a.com', 'MBBS', 'gyno', 20000);
insert into doctor values('d003', 'd003', 'Dr. C', 'Elephant Road', 01682980425, 31, 'current', 'a@a.com', 'MBBS', 'neuro', 20000);
insert into doctor values('d004', 'd004', 'Dr. D', 'Elephant Road', 01682980426, 31, 'current', 'a@a.com', 'MBBS', 'medicine', 20000);
insert into doctor values('d005', 'd005', 'Dr. E', 'Elephant Road', 01682980427, 31, 'onleave', 'a@a.com', 'MBBS', 'heart', 20000);
insert into doctor values('d006', 'd005', 'Dr. A', 'Elephant Road', 01682980427, 31, 'onleave', 'a@a.com', 'MBBS', 'medicine', 20000);
...
insert into login values ('e004','e004','clerk');
insert into login values ('e005','e004','clerk');